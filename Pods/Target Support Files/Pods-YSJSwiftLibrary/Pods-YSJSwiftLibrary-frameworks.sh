...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/AlertHud/AlertHud.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/KVStore/KVStore.framework"
  install_framework "$BUILT_PRODUCTS_DIR/MBProgressHUD/MBProgressHUD.framework"
  install_framework "$BUILT_PRODUCTS_DIR/MJRefresh/MJRefresh.framework"
  install_framework "$BUILT_PRODUCTS_DIR/MediaPicker/MediaPicker.framework"

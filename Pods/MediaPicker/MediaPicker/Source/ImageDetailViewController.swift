...
//    }
    ...
    func initConstraint() {
        ...
        let selectImageViewTopConstraint = NSLayoutConstraint(item: selectImageView, attribute: .top, relatedBy: .equal, toItem: selectNumLabel, attribute: .top, multiplier: 1.0, constant: 0)
        
        let selectImageViewBottomConstraint = NSLayoutConstraint(item: selectImageView, attribute: .bottom, relatedBy: .equal, toItem:selectNumLabel , attribute: .bottom, multiplier: 1.0, constant: 0)
        
        let selectImageViewLeftConstraint = NSLayoutConstraint(item: selectImageView, attribute: .left, relatedBy: .equal, toItem: selectNumLabel, attribute: .left, multiplier: 1.0, constant: 0)
        
        let selectImageViewRightConstraint = NSLayoutConstraint(item: selectImageView, attribute: .right, relatedBy: .equal, toItem: selectNumLabel, attribute: .right, multiplier: 1.0, constant: 0)
        
        selectImageViewTopConstraint.isActive = true
        selectImageViewBottomConstraint.isActive = true
        selectImageViewLeftConstraint.isActive = true
        selectImageViewRightConstraint.isActive = true
    ...
    func initView() {
        ...
        //返回按钮
        backBtn.setImage(imageFromBundle(imageName: IPImageNameWhiteReturnIcon), for: .normal)
        ...
        selectBackImageView.image = imageFromBundle(imageName: IPImageNameUmSelectCamera)
    ...
    func initSinglePageStruct(index: Int) {
        ...
        if detailArray[index].modelType == .videoAssetModel {
            ...
            pageBtn.setImage(imageFromBundle(imageName: IPImageNamePlayButtonIcon), for: .disabled)
            pageBtn.setImage(imageFromBundle(imageName: IPImageNameRemoveIcon), for: .selected)
